...
public class ArticleWordLookupRow {
    private String contentId,speechKey,term,phonetic,meaning,audioAssetId,sourceKind;
    ...
    public String getAudioAssetId(){return audioAssetId;} public void setAudioAssetId(String v){audioAssetId=v;}
