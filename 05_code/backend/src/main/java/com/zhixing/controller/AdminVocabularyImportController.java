...
public class AdminVocabularyImportController {
    ...
    @DeleteMapping("/import-batches/{id}") public Map<String,Object> deleteBatch(@RequestHeader(value="X-Admin-Token",required=false) String token,@PathVariable String id){admin(token);return imports.deleteBatch(id,properties.getAdminPrincipalId());}
