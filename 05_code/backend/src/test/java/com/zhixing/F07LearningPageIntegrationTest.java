...
class F07LearningPageIntegrationTest {
    ...
    private void seed(String ownerId){String source="11111111111111111111111111111111";jdbc.update("INSERT INTO content_source (id,name,license_note) VALUES (?,?,?)",source,"测试来源","测试许可");
