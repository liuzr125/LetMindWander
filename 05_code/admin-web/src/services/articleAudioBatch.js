...
const STOP_CODES = new Set([
  ...
  'TTS_APP_KEY_REJECTED', 'TTS_NOT_CONFIGURED', 'TTS_APP_KEY_UNREADABLE', 'CREDENTIAL_KEY_UNAVAILABLE', 'MEDIA_STORE_FAILED',
  'TTS_AUDIO_MERGER_UNAVAILABLE', 'TTS_AUDIO_MERGE_FAILED',
