-- 知行日课 V3.14 数据库初始化最终版 / MySQL 5.7.25
-- 用途：仅用于空库首次初始化；不创建数据库，请先选择正确的空库。
-- 内容：V3.0 的 62 表稳定基线 + V3.1/V3.9 词书 3 表 + V3.8/V3.10-V3.14 最终结构与字典。
...
-- ---- 合并自 V3.14_article_word_glossary.sql ----
