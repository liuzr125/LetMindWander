...
2. [HTML字段字典](../数据字典/知行日课_数据库字典_V3.14.html)覆盖76张表、914个字段和全部索引。
...
5. 机器可读结构、HTML字典与最终SQL保持同版：R1原43表保留，V3.0新增19表，V3.1/V3.9新增3张词书表；V3.8新增7张记忆训练表，V3.12新增AI模型配置表，V3.13新增TTS日志表并扩展content_version，V3.14新增短文点词词汇表，另纳入app_parameter运行参数表。
